    ...
    <Box sx={{ display: 'flex', minHeight: '100vh' }}>
      ...
      >
        <Toolbar>
          ...
          {/* الشعار - يظهر في الوضع المضيء والداكن */}
            <Typography 
              variant="h3" 
              sx={{ 
                flexGrow: 1, 
      ...
      >
        ...
        <MenuItem onClick={handleNotifClose}>
          <Box>
            <Typography variant="body2" fontWeight="bold">مرحباً بك</Typography>
            <Typography variant="caption" color="textSecondary">تم تسجيل الدخول بنجاح</Typography>
          </Box>
        </MenuItem>
        <Divider />
        <Box p={2} textAlign="center">
          <Typography variant="caption" color="textSecondary">لا توجد إشعارات جديدة</Typography>
        </Box>
      </Menu>
      ...
      <Box component="nav" sx={{ width: { sm: drawerWidth }, flexShrink: { sm: 0 } }}>
        ...
        <Drawer
          variant="permanent"
          sx={{ display: { xs: 'none', sm: 'block' }, '& .MuiDrawer-paper': { width: drawerWidth, boxSizing: 'border-box', borderRight: 'none', bgcolor: 'transparent' } }}
          open
        >
          {drawer}
        </Drawer>
